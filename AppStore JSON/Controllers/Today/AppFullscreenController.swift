...
class AppFullscreenController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        let translationY = -90 - (window?.windowScene?.statusBarManager?.statusBarFrame.height ?? 0)
...
//        let bottomPadding = view.window?.windowScene?.statusBarManager?.statusBarFrame.height ?? 16
